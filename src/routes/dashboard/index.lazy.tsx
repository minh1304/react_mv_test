...
function DashboardComponent() {
  ...
  if (error) return <p className="text-center text-red-500">{error instanceof Error ? error.message : 'An error occurred'}</p>;
        ...
        <>
          ...
          <div className="flex justify-center items-center gap-4 mt-8">
            <button
              ...
              className={`px-4 py-2 rounded bg-gray-500 text-white ${page === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-600'}`}
            >
              Previous
            </button>
            ...
            <button
              ...
              className={`px-4 py-2 rounded bg-gray-500 text-white ${isFetching || (data && data.length < limit) ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-600'}`}
            >
              Next
            </button>
          </div>
